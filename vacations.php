                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><b><?php if((int)$row['dovolenka'] == 0) { echo 'Nemá zadanú dovolenku'; } else{echo $row['dovolenka']; }  ?></b></td>
                                <td><b><?php echo 25-(int)$row['dovolenka'] ?></b></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
